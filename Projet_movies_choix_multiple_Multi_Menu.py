...
import IdentifiantServeurDataLab # A modifier et mettre le fichier.py qui contient l'identifiant et le mot de passe de l'utilisateur  qui est à placer dans le même dossier que ce scripte.py
